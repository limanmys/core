                ...
                <div class="card-body">
                    <form class="form-horizontal" onsubmit="return saveUser(this)">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputName" name="name" value="{{auth()->user()->name}}" required minlength="6" maxlength="255" @if(user()->auth_type == "ldap" || user()->auth_type == "keycloak") disabled @endif>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputEmail" class="col-sm-2 col-form-label">{{__("Email Adresi")}}</label>
                            <div class="col-sm-10">
                            <input type="email" class="form-control" id="inputEmail" value="{{auth()->user()->email}}" disabled required @if(user()->auth_type == "ldap" || user()->auth_type == "keycloak") disabled @endif>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputOldPassword" class="col-sm-2 col-form-label">{{__("Eski Parola")}}</label>
                            <div class="col-sm-10">
                            <input type="password" class="form-control" id="inputOldPassword" name="old_password" required minlength="10" maxlength="32" @if(user()->auth_type == "ldap" || user()->auth_type == "keycloak") disabled @endif>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputPassword" class="col-sm-2 col-form-label">{{__("Parola")}}</label>
                            <div class="col-sm-10">
                            <input type="password" class="form-control" id="inputPassword" name="password" minlength="10" maxlength="32" @if(user()->auth_type == "ldap" || user()->auth_type == "keycloak") disabled @endif>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="password" class="form-control" id="inputPasswordConfirmation" name="password_confirmation" minlength="10" maxlength="32" @if(user()->auth_type == "ldap" || user()->auth_type == "keycloak") disabled @endif>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="offset-sm-2 col-sm-10">
                            <button type="submit" class="btn btn-danger" @if(user()->auth_type == "ldap" || user()->auth_type == "keycloak") disabled @endif>{{__("Kaydet")}}</button>
                            </div>
                        </div>
                    </form>
                </div>
