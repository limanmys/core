        ...
        <div class="col-md-3">
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <p class="text-muted text-center mb-0">{{ __("Bu sayfadan mevcut yetki taleplerini görebilirsiniz. İşlem yapmak istediğiniz talebe sağ tıklayarak işlem yapabilirsiniz.") }}</p>
              </div>
            </div>
        </div>
        <div class="col-md-9">
