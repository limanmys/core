...
<body style="display: block">
    <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
            <span class="navbar-brand col-sm-3 col-md-2 mr-0" style="cursor: default"><span style="line-height: 30px;">{{ __("Liman Sistem Yönetimi") }}</span><i style="cursor: pointer;line-height: 30px;" onclick="navbar(true)" class="float-right fas fa-bars"></i></span>
            @auth
