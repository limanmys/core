...
Route::group(['middleware' => ['auth','permissions']], function () {
    ...
    Route::group(['middleware' => ['server']], function () {
        Route::get('/l/{extension}/{city}/{server_id}', 'ExtensionsController@server')->name('extension_server');
        ...
        Route::post('/sunucu/kontrol', 'ServerController@check')->name('server_check')->middleware('parameters:extension,server_id');
    ...
    Route::get('/l/{extension}', 'ExtensionsController@index')->name('extension');
    Route::get('/l/{extension}/{city}', 'ExtensionsController@city')->name('extension_city');
    ...
    Route::get('/eklentiler/{extension_id}','ExtensionsController@one')->name('extension_one');
});