...
Release: 0
License: MIT
Requires: curl, gpgme, zip, unzip, nginx, crontabs, redis, php, php-fpm, php-pecl-redis5, php-pecl-zip, php-gd, php-snmp, php-mbstring, php-xml, php-pdo, openssl, supervisor, php-pgsql, php-bcmath, rsync, bind-utils, php-ldap, libsmbclient, samba-client, php-smbclient, novnc, python39, python3-paramiko, python3-tornado, python3-websockify, postgresql, postgresql-server
Prefix: /liman
Summary: Liman MYS
