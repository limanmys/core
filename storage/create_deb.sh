...
Depends: curl, gpg, zip, unzip, nginx, redis, php7.3-redis | php-redis, php7.3-fpm, php7.3-gd, php7.3-curl, php7.3, php7.3-sqlite3, php7.3-snmp, php7.3-mbstring, php7.3-xml, php7.3-zip, php7.3-posix, libnginx-mod-http-headers-more-filter, libssl3, supervisor, postgresql-13, php7.3-pgsql, pgloader, php7.3-bcmath, rsync, dnsutils, php7.3-ldap, php7.3-smbclient | php-smbclient, krb5-user, php7.3-ssh2 | php-ssh2, smbclient, novnc, python3.7 | python3.8 | python3.9 | python3.10, python3-paramiko, python3-tornado""" > DEBIAN/control
cat DEBIAN/control
cd ../
