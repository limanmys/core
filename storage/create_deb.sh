...
Depends: curl, gpg, zip, unzip, nginx, redis, php8.1-redis | php-redis, php8.1-fpm, php8.1-gd, php8.1-curl, php8.1, php8.1-sqlite3, php8.1-snmp, php8.1-mbstring, php8.1-xml, php8.1-zip, php8.1-posix, libnginx-mod-http-headers-more-filter, libssl1.1 | libssl3, supervisor, postgresql-13, php8.1-pgsql, pgloader, php8.1-bcmath, rsync, dnsutils, php8.1-ldap, php8.1-smbclient | php-smbclient, krb5-user, php8.1-ssh2 | php-ssh2, smbclient, novnc, python3.7 | python3.8 | python3.9 | python3.10, python3-paramiko, python3-tornado""" > DEBIAN/control
cat DEBIAN/control
cd ../
